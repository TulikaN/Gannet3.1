function [fid] = specInvFft_Gannet(spec,dim)
...
% 
% EXAMPLE:
% zz=randn(2048,1)+1i*randn(2048,1);maxdiff(zz,specInvFft_Gannet(specInvFft(zz)))
% OR
% zz=randn(2048,128)+1i*randn(2048,128);maxdiff(zz,specInvFft_Gannet(specInvFft(zz)));maxdiff(zz,specInvFft_Gannet(specInvFft(zz,2),2))
