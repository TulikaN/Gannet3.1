function [spec] = specFft_Gannet(fid,dim)
...
%
% EXAMPLE:
% zz=randn(2048,1)+1i*randn(2048,1);maxdiff(zz,specFft_Gannet(specInvFft(zz)))
% OR
% zz=randn(2048,128)+1i*randn(2048,128);maxdiff(zz,specFft_Gannet(specInvFft(zz)));maxdiff(zz,specFft_Gannet(specInvFft(zz,2),2))
